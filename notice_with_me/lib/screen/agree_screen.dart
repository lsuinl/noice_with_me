          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                  ...
                  width: 320.w,
                  child:
                  Padding(padding: EdgeInsets.symmetric(vertical: 40,horizontal: 30),
                  child:
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("약관동의", style: TextStyle(fontSize: 28.sp),),
                      ...
                      Row(
                        children: [
                          ...
                          Text("전체동의",style: TextStyle(fontSize: 15.sp,color: Colors.black87),),
                        ],
                      ),
                      ...
                      Row(
                        children: [
                          ...
                          TextButton(
                              onPressed: () {}, child: Text("개인정보 이용 약관 >",style: TextStyle(fontSize: 15.sp,color: Colors.black87)),)
                        ],
                      ),
                      Container(height: 1.h, width:280.w, color: Colors.black),
                      Row(
                        children: [
                          ...
                          TextButton(
                              onPressed: () {}, child: Text("서비스 이용 약관 >",style: TextStyle(fontSize: 15.sp,color: Colors.black87)))
                        ],
                      ),
                      Container(height: 1.h, width:280.w, color: Colors.black),
                      Row(
